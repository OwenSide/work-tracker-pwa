          ...
          <motion.div initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }} className="flex-1 min-h-0 flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto pb-24 no-scrollbar">
              ...
              <div className="flex flex-col gap-2">
                ...
                ) : (currentMonthData.shifts.map(shift => renderShiftItem(shift)))}
              </div>
            </div>
          </motion.div>
        )}
              ...
              <div className="flex flex-col gap-3">
                {archiveMonths.length === 0 ? (
                  ...
                  archiveMonths.map(month => (
                    <div key={month.id} className="bg-zinc-900/50 border border-white/5 rounded-2xl overflow-hidden shrink-0">
